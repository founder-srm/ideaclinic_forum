...
export default function Page() {
    ...
    return (
        <main className="w-screen flex flex-col items-center justify-center h-full bg-[#090909]">
            <Link
                href="/account"
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10 flex flex-col">
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Associate Professor" type="text" {...field} />
                                    </FormControl>
                                    <FormDescription>
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea className="text-black" placeholder="Hi! I am a..... " {...field} />
                                    </FormControl>
                                    <FormDescription>
